...
if(!in_array($find_menu1['id'], $item_array_id)){
    ...
    $_SESSION['add_cart'][$p_id]['product_qty'] += 1;
}
...
<li>
    <a class="pull-left" href="cart.php">
        <button type="button" class="btn btn-danger order-weight">View All</button>
    </a>
</li>
<li>
    <button type="button" class="btn btn-danger pull-right empty_cart_btn" onclick="empty_card()">
        Empty Cart
    </button>
</li>';
?>
