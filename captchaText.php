<?php 
    ...
    {
        public function captchatext($text,$textcolor,$backgroundColor='',$fontSize,$imgWidth,$imgHeight,$dir,$fileName)
        {
            $font = './calibari.ttf';
            ...
            if($backgroundColor==''){
                ...
                $backgroundColor = imagecolorLLocate($im, $backgroundColor['r'],$backgroundColor['g'],$backgroundColor['b']);
            }else{
        ...
        public function phpcaptcha($textColor,$backgroundColor,$imgWidth,$imgHeight,$noiceLines=0,$noiceDots=0,$noiceColor='#162453')
        {
            ...
            $im = imagecreatetruecoLor($imgWidth, $imgHeight);
            $textColor = imagecolorLLocate($im, $textColor['r'],$textColor['g'],$textColor['b']);
            $backgroundColor = $this->hexToRGB($backgroundColor);
            $backgroundColor = imagecoloraLLocate($im, $backgroundColor['r'], $backgroundColor['g'], $backgroundColor['b']);
        ...
        protected function random($characters=6,$letters='ABCDEFGHIJhdsdghdfdh674856'){
            $str='';
        ...
        protected function ImageTTFCenter($image, $text, $font, $fontSize, $angle = 8)
        {
            $xi = imagesx($image);
            $yi = imagesy($image);
